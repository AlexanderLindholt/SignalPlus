...
<a href="https://wally.run/package/alexanderlindholt/signalplus" class="button primary">View Wally Package</a>

* Open project directory in a terminal.
* Initialize with `wally init`.
* Add Signal+ in the  `wally.toml` file:

```toml
[dependencies]
Tween = "alexanderlindholt/signalplus@*"
```
